                            ...
                            {Array.from({ length: stats.edges }, (_, i) => (
                              ...
                              >
                                ...
                                <div className="ml-auto flex items-center gap-2">
                                  ...
                                  />
                                  <button
                                    onClick={() => toggleEdgeHighlight(i)}
                                    className={`px-2 py-1 text-xs rounded ${
                                      highlightedEdges[i]
                                        ? 'bg-green-100 text-green-700'
                                        : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                    }`}
                                    title={highlightedEdges[i] ? 'Remove highlight' : 'Highlight edge'}
                                  >
                                    {highlightedEdges[i] ? 'Highlighted' : 'Highlight'}
                                  </button>
                                </div>
                              </div>
                            ))}
                              ...
                              >
                                ...
                                <div className="ml-auto flex items-center gap-2">
                                  ...
                                  <button
                                    ...
                                    title={highlightedVertices[i] ? 'Remove highlight' : 'Highlight vertex'}
                                  >
                                    {highlightedVertices[i] ? 'Highlighted' : 'Highlight'}
                                  </button>
                                </div>
                              </div>
                            ))}
